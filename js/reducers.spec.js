...
test('details', () => {
  ...
  state = reducers({
    ...
    omdbData: {
      ...
      Language: 'English',
      Country: 'USA',
      Awards: 'Won 2 Golden Globes. Another 25 wins & 179 nominations.',
      Poster: 'https://images-na.ssl-images-amazon.com/images/M/MV5BMjM3ODMyMjc3MV5BMl5BanBnXkFtZTgwNDgzNDc5NzE@._V1_SX300.jpg',
      Metascore: 'N/A',
      imdbRating: '9.0',
      imdbVotes: '350,897',
      imdbID: 'tt1856010',
